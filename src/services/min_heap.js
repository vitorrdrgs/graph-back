class MinHeap {
  ...
  delete(value) {
    ...
    for (let i = 0; i < this.#arr.length; ++i) {
      if (
        value.cost === this.#arr[i].cost &&
        value.vertex === this.#arr[i].vertex
      ) {
        index = i
        break
      }
  ...
  heapify(i) {
    ...
    if (l < this.#arr.length && this.#arr[l].cost < this.#arr[smallest].cost)
      smallest = l
    if (r < this.#arr.length && this.#arr[r].cost < this.#arr[smallest].cost)
      smallest = r
