...
router.put(
  '/update/:id',
  middleware_token_verify,
  graphs_controller.update_grafo_id
)
...
router.post(
  '/dijkstra/matrix',
  middleware_search_algorithms_input_verify,
  graphs_controller.dijkstra_matrix
)
router.post(
  '/dijkstra/list',
  middleware_search_algorithms_input_verify,
  graphs_controller.dijkstra_list
)
